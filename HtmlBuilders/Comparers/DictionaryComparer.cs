...
namespace HtmlBuilders.Comparers {
  internal static class DictionaryComparer {
    ...
    internal static bool Equals(IEnumerable<KeyValuePair<string, string>> leftDictionary,
      IEnumerable<KeyValuePair<string, string>> rightDictionary, params string[] keysToExclude) {
